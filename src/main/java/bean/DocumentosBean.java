...
public class DocumentosBean implements Serializable{
    ...
    public String salvaDocumentos() throws SQLException {
            ...
            try {
                this.objDocumentosBD.inserirDocumentos(fileUploadBean.getName(), fileUploadBean.getUrl(), loginBean.getId());
    ...
    public List<Documentos> getListarDocumentos(){
        ...
        try{
            System.out.println("o valor do id do login no momento eh: "+loginBean.getId());
            lstDocumentos = objDocumentosBD.listarDocumentos(loginBean.getId());
