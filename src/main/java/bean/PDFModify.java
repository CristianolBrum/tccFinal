...
public class PDFModify {
    ...
    public void modificaPDF(String url, String nome) {
        try {
            ...
            String filePath = "C:\\Users\\Usuario\\Documents\\qrcode\\" +nome+".png";
            int size = 125;
            String fileType = "png";
            ...
            PdfReader pdfReader = new PdfReader("C:\\Users\\Usuario\\Documents\\fotos\\" +nome);

            //Create PdfStamper instance.
            PdfStamper pdfStamper = new PdfStamper(pdfReader, new FileOutputStream("C:\\Users\\Usuario\\Documents\\pdf\\" +nome));
            PdfContentByte content = pdfStamper.getOverContent(1);
            Image image = Image.getInstance("C:\\Users\\Usuario\\Documents\\qrcode\\" +nome+".png");
